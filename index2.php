     ...
     <div class="container">
       ...
       <div class="nav-collapse collapse" id="main-menu">
        <ul class="nav social" id="main-menu-left">
          <li><a onclick="pageTracker._link(this.href); return false;" href="http://news.bootswatch.com">ABOUT</a></li>
          <li><a id="swatch-link" href="../#gallery">BLOG</a></li>
	  <li><a id="swatch-link" href="../#gallery">RESUME</a></li>			
	  <li style="padding-left:130px;"><a class="ss-icon ss-social-circle" href="https://github.com/mjw56">github</a></li>
